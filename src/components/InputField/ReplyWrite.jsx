...
const ReplyWrite = ( {reply, setReply, submitHandler} ) => {
  ...
  return (
    <div className='reply-write-container'>
      <React.Fragment>
        <div>
          <input className='reply-input-writer' placeholder='작성자' autoComplete='off' value={reply.writer} onChange={writerChangeHandler}></input>
          <input className='reply-input-password' type='password' placeholder='비밀번호' autoComplete='off' value={reply.password} onChange={passwordChangeHandler}></input>
        </div>
